...
if __name__== '__main__':
    ...
    parser.add_argument("--checkpoint", type=str, default='experiments/checkpoint.pt', help='path to save checkpoint')

    parser.add_argument("--ds_cfg_path", type=str, default='config/data.yaml', help='path to dataset config')
    parser.add_argument("--aug_cfg_path", type=str, default='config/transform.yaml', help='path to aug config')
    parser.add_argument("--tr_cfg_path", type=str, default='config/train.yaml', help='path to training config')
