...
def main():
    ...
    p.add_argument("--ckpt", type=str, default="experiments/outputs/best.pt", help="path to original checkpoint (best.pt)")
    p.add_argument("--out", type=str, default="experiments/outputs/best_qint8.pt", help="output quantized checkpoint")
    args = p.parse_args()
